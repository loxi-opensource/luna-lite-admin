<template>
    ...
    <el-input class="w-[280px]" v-model="queryParams.type" clearable placeholder="请输入反馈类型" />
</el-form-item>
    ...
    <el-input class="w-[280px]" v-model="queryParams.mobile" clearable placeholder="请输入联系方式" />
        ...
        <el-card class="!border-none" v-loading="pager.loading" shadow="never">
            <el-button v-perms="['feedback/add']" type="primary" @click="handleAdd">
                <template #icon>
            ...
            <div class="mt-4">
                <el-table :data="pager.lists" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="反馈类型" prop="type" show-overflow-tooltip />
...
import { apiFeedbackLists, apiFeedbackDelete } from '@/api/feedback'
